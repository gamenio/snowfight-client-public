...
class GPG_EXPORT AndroidPlatformConfiguration {
 public:
   ...
   * Destination App by selecting a snapshot. This can be overridden by setting
   * a new callback with {@link SetOnLaunchedWithSnapshot}.
   */
 ...
 private:
  AndroidPlatformConfiguration(const AndroidPlatformConfiguration &) = delete;
  AndroidPlatformConfiguration &operator=(
      const AndroidPlatformConfiguration &) = delete;
