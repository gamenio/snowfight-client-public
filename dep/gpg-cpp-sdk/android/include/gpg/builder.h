...
class GPG_EXPORT GameServices::Builder {
 public:
  ...
  /**
   * Sets whether a resolution popup should be displayed automatically
   * during silent sign-in flow if required. By default this is enabled.
   */
  Builder &SetEnableSilentSignInResolution(bool enable_resolution);
