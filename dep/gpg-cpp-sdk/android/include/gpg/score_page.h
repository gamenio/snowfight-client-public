...
class GPG_EXPORT ScorePage {
 public:
  ...
  class Entry {
   public:
     ...
     */
    explicit Entry(std::shared_ptr<const EntryImpl> impl);
   ...
   private:
    std::shared_ptr<const EntryImpl> impl_;
  };
  ...
  class ScorePageToken {
   public:
     ...
     * Explicit constructor.
     */
    explicit ScorePageToken(std::shared_ptr<const ScorePageTokenImpl> impl);
   ...
   private:
    ...
    std::shared_ptr<const ScorePageTokenImpl> impl_;
  };
   ...
   * Explicit constructor.
   */
  explicit ScorePage(std::shared_ptr<const ScorePageImpl> impl);
 ...
 private:
  ...
  std::shared_ptr<const ScorePageImpl> impl_;
};
