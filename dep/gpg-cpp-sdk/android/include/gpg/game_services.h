 ...
 * callback arguments reflect a successful sign-in attempt, the instance can be
...
class GPG_EXPORT GameServices {
 public:
   ...
   * @deprecated Real-time multiplayer and Turn-based multiplayer support is
   * being shut down on March 31, 2020. See <a
   *     href="https://support.google.com/googleplay/android-developer/answer/9469745">Multiplayer
   *     deprecation</a>
   */
  TurnBasedMultiplayerManager &TurnBasedMultiplayer() GPG_DEPRECATED;
   ...
   *     deprecation</a>
   */
  RealTimeMultiplayerManager &RealTimeMultiplayer() GPG_DEPRECATED;
   ...
   *     deprecation</a>
   */
  const RealTimeMultiplayerManager &RealTimeMultiplayer() const GPG_DEPRECATED;
