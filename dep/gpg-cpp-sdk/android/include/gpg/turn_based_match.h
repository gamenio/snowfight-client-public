 ...
 * @deprecated Real-time multiplayer and Turn-based multiplayer support is being
 * shut down on March 31, 2020. See <a
...
class GPG_EXPORT TurnBasedMatch {
 public:
   ...
   */
  explicit TurnBasedMatch(std::shared_ptr<const TurnBasedMatchImpl> impl);
 ...
 private:
  ...
  std::shared_ptr<const TurnBasedMatchImpl> impl_;
};
