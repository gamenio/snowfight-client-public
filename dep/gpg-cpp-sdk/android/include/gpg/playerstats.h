...
class GPG_EXPORT PlayerStats {
 public:
   ...
   */
  bool HasChurnProbability() const GPG_DEPRECATED;

  /**
   * Retrieves the churn probability for this player, if known.
   * <code>HasChurnProbability()</code> must return true for this function
   * to be usable.
   * @deprecated <code>HasChurnProbability()</code> always returns false.
   */
  float ChurnProbability() const GPG_DEPRECATED;
   ...
   * @deprecated This method always returns false.
   */
  bool HasHighSpenderProbability() const GPG_DEPRECATED;
   ...
   * @deprecated <code>HasHighSpenderProbability()</code> always returns false.
   */
  float HighSpenderProbability() const GPG_DEPRECATED;
   ...
   * @deprecated This method always returns false.
   */
  bool HasSpendProbability() const GPG_DEPRECATED;
   ...
   * to be usable.
   * @deprecated <code>HasSpendProbability()</code> always returns false.
   */
  float SpendProbability() const GPG_DEPRECATED;
   ...
   * @deprecated This method always returns false.
   */
  bool HasTotalSpendNext28Days() const GPG_DEPRECATED;
   ...
   * function to be usable.
   * @deprecated <code>HasTotalSpendNext28Days()</code> always returns false.
   */
  float TotalSpendNext28Days() const GPG_DEPRECATED;
