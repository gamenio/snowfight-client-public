...
// 单位
#define UNIT_OBJECT_SIZE					cocos2d::Size(24, 32)
...
// 抛射体
#define PROJECTILE_OBJECT_SIZE				cocos2d::Size(10, 10)
#define PROJECTILE_ANCHOR_POINT				cocos2d::Point(0.5f, 0.5f)
#define PROJECTILE_OBJECT_RADIUS_IN_MAP		5.f

// 物品箱
#define ITEMBOX_OBJECT_SIZE					cocos2d::Size(32, 32)
#define ITEMBOX_ANCHOR_POINT				cocos2d::Point(0.5f, 0.0f)
#define ITEMBOX_OBJECT_RADIUS_IN_MAP		16.f
#define ITEMBOX_LAUNCH_CENTER				cocos2d::Point(0, 10)
