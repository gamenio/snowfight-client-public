...
public:
	...
	virtual Parcel* New() const  override { return NULL; }
	virtual void Clear()  override;
	virtual std::string GetTypeName() const  override { return "Parcel"; }
	virtual bool IsInitialized() const  override { return true; }
	virtual void CheckTypeAndMergeFrom(::google::protobuf::MessageLite const& from)  override { }

	virtual bool MergePartialFromCodedStream(::google::protobuf::io::CodedInputStream* input) override;
